  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {/* Main Worker Panel Section with Image */}
        <View style={styles.mainPanelContainer}>
          {/* Image above the button */}
          <Image
            source={require("../../assets/workers.png")} // Replace with your image path
            style={styles.workerBannerImage}
            resizeMode="cover"
          />
...
const styles = StyleSheet.create({
  ...
  workerBannerImage: {
    ...
    borderRadius: 16,
    marginBottom: 12, // Space between image and button
  },
});